            ...
            <div className={styles.menu__control}>
                <div className={styles['menu__control-container']}>
                    <input
                        type="checkbox"
                        id="menuIconCheck"
                        className={styles['menu-icon__check']}
                        onChange={() => setIsMenuOpened(!isMenuOpened)}
                    />
                    <label
                        className={styles['menu-icon']}
                        htmlFor="menuIconCheck"
                        aria-label={
                            isMenuOpened ? 'Fermer le menu' : 'Ouvrir le menu'
                        }
                    >
                        <span
                            className={styles['menu-icon__bar']}
                            aria-hidden="true"
                        />
                        <span
                            className={styles['menu-icon__bar']}
                    ...
                    >
                        <ul className={styles.menu__list}>
                            ...
                            <li className={styles['menu__list-item']}>
                                <a href="mailto:vincent_blouin@outlook.com">
                                    Contact
                                </a>
                            </li>
                        </ul>
                ...
                <a className={styles['menu__logo-link']} href="/">
                    <img alt="logo" src="/logo.png" />
                </a>
                <ul className={styles['social-media__list']}>
                    {socialMediaLinks.map((socialMediaLink) => (
                        <li
                            className={styles['social-media__list-item']}
                            key={socialMediaLink._id}
                        >
                            <a
