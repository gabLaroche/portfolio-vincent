...
const Affiliate = ({ doc }) => {
  ...
  return (
    <Layout
      title="Vincent Blouin | Produits Affiliés"
            ...
            <ul className={styles['product-list']}>
              {category.affiliateProducts.map((product) => (
                <li className={styles['product-list-item']} key={product._id}>
                  <a
                    className={styles['product-list-item-link']}
                    href={product.link}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <img
                      className={styles['product-list-item-img']}
                    ...
                    <p className={styles['product-list-item-bottom']}>
                      <span className={styles['product-list-item-name']}>
                        {product.productName}
                      </span>
